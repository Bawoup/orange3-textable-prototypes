...
__version__ = u"0.0.1"
__author__ = "Joël Huck, Lara Lambelet, Zakari Rabet et Mathieu Perring"
__maintainer__ = ""
__email__ = ""
...
class Parathon(OWTextableBaseWidget):
    ...
    name = "Parathon"
    description = "Analyse and create a segmentation with paratextual elements"
    ...
    def __init__(self):
        ...
        self.titleListbox = gui.listBox(
            widget=titleBox,
            master=self,
            value="selectedDictionaries",    # setting (list)
            labels="titleLabels",      # setting (list)
            callback=self.sendButton.settingsChanged,
            tooltip="The list of dictionaries used to create a segmentation",
        )
        ...
        gui.button(
            ...
            master=self,
            label="Select All",
            callback=self.selectAllDictionaries,
            tooltip="Select all dictionaries",
        )
        gui.button(
            widget=titleBox,
            master=self,
            label="Deselect All",
            callback=self.deselectAllDictionaries,
            tooltip="Deselect all dictionaries",
        )
        gui.separator(widget=titleBox, height=3)
